...
exports.run = async (client, message, args) => {
  ...
  if (message.author.id !== ayarlar.sahip) return message.channel.send(`Capslock engelleme adlý komutu kullanabilmek için, siteyi ziyaret ediniz.`)
  ...
  if (capslock) {
    ...
    message.channel.send(`:fire: Capslock engelleme sistemi, kapatýldý!`)
  }
...
exports.help = {
  ...
  category: 'Moderasyon komutlarý!',
  description: 'Capslock kullanýmýný engeller.',
